...
package org.bhc.common.crypto;

import static org.bhc.common.utils.BIUtil.isLessThan;
import static org.bhc.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.bhc.common.crypto.jce.ECKeyAgreement;
import org.bhc.common.crypto.jce.ECKeyFactory;
import org.bhc.common.crypto.jce.ECKeyPairGenerator;
import org.bhc.common.crypto.jce.ECSignatureFactory;
import org.bhc.common.crypto.jce.TronCastleProvider;
...
public class ECKey implements Serializable {
  ...
  public static byte[] recoverPubBytesFromSignature(int recId,
    ...
    //        specified in Section 2.3.7, where mlen = 鈱�(log2 p)/8鈱� or
    // mlen = 鈱坢/8鈱�.
    ...
    // conversion routine outputs 鈥渋nvalid鈥�, then
   ...
   *
   * @return 21-byte address   这是公钥的hash值，不是账户地址
   */
  ...
  public ECDSASignature doSign(byte[] input) {
    ...
    if (privKey instanceof BCECPrivateKey) {
      ...
      BigInteger[] components = signer.generateSignature(input);   //生成两个大整数r，s，创建ECDSASignature对象保存下来
