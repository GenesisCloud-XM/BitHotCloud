...
import static org.bhc.common.runtime.utils.MUtil.convertToTronAddress;
import static org.bhc.common.utils.BIUtil.addSafely;
import static org.bhc.common.utils.BIUtil.isLessThan;
import static org.bhc.common.utils.BIUtil.isZero;
import static org.bhc.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.bhc.common.utils.ByteUtil.bytesToBigInteger;
import static org.bhc.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.bhc.common.utils.ByteUtil.parseBytes;
import static org.bhc.common.utils.ByteUtil.parseWord;
import static org.bhc.common.utils.ByteUtil.stripLeadingZeroes;
...
import org.bhc.common.crypto.zksnark.BN128;
import org.bhc.common.crypto.zksnark.BN128Fp;
import org.bhc.common.crypto.zksnark.BN128G1;
import org.bhc.common.crypto.zksnark.BN128G2;
import org.bhc.common.crypto.zksnark.Fp;
import org.bhc.common.crypto.zksnark.PairingCheck;
import org.bhc.common.runtime.vm.program.Program;
import org.bhc.common.runtime.vm.program.ProgramResult;
import org.bhc.common.storage.Deposit;
import org.bhc.common.utils.BIUtil;
...
import org.bhc.core.actuator.ProposalApproveActuator;
import org.bhc.core.actuator.ProposalCreateActuator;
import org.bhc.core.actuator.ProposalDeleteActuator;
import org.bhc.core.actuator.VoteWitnessActuator;
import org.bhc.core.actuator.WithdrawBalanceActuator;
...
//    }
  ...
  /**
   * Computes point addition on Barreto鈥揘aehrig curve. See {@link BN128Fp} for details<br/> <br/>
   *
  ...
  /**
   * Computes multiplication of scalar value on a point belonging to Barreto鈥揘aehrig curve. See
  ...
  public static class VoteWitnessNative extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      try {
        ...
        voteWitnessActuator.validate();       //调用执行函数完成个人票数处理任务
