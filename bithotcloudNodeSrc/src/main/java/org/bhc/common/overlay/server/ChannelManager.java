...
import static org.bhc.protos.Protocol.ReasonCode.TOO_MANY_PEERS;
import static org.bhc.protos.Protocol.ReasonCode.TOO_MANY_PEERS_WITH_SAME_IP;
import static org.bhc.protos.Protocol.ReasonCode.UNKNOWN;
...
import org.bhc.common.overlay.client.PeerClient;
...
public class ChannelManager {
  ...
  public synchronized boolean processPeer(Channel peer) {
    ...
    //先在activePeers查找是否存在，不存在才添加peer。
