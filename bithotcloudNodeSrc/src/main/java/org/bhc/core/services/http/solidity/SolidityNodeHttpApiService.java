...
import org.bhc.core.services.http.GetAccountServlet;
import org.bhc.core.services.http.GetAssetIssueByIdServlet;
import org.bhc.core.services.http.GetAssetIssueByNameServlet;
import org.bhc.core.services.http.GetAssetIssueListByNameServlet;
import org.bhc.core.services.http.GetAssetIssueListServlet;
import org.bhc.core.services.http.GetBlockByNumServlet;
import org.bhc.core.services.http.GetDelegatedResourceAccountIndexServlet;
import org.bhc.core.services.http.GetDelegatedResourceServlet;
import org.bhc.core.services.http.GetExchangeByIdServlet;
import org.bhc.core.services.http.GetNodeInfoServlet;
import org.bhc.core.services.http.GetNowBlockServlet;
import org.bhc.core.services.http.GetPaginatedAssetIssueListServlet;
import org.bhc.core.services.http.GetTransactionCountByBlockNumServlet;
import org.bhc.core.services.http.ListExchangesServlet;
import org.bhc.core.services.http.ListWitnessesServlet;
  ...
  public void start() {
    ...
    try {
      ...
      if (args.isWalletExtensionApi()) {
        ...
        context.addServlet(new ServletHolder(getTransactionsToThisServlet),
