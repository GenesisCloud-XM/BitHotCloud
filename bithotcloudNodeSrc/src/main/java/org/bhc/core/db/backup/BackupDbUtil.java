...
import org.bhc.core.db2.core.SnapshotRoot;
  ...
  private void backup(int i) throws RocksDBException {
    ...
    for (RevokingDBWithCachingNewValue store : stores) {
      if (((SnapshotRoot) (store.getHead().getRoot())).getDb().getClass()
          == org.bhc.core.db2.common.RocksDB.class) {
        ((org.bhc.core.db2.common.RocksDB) ((SnapshotRoot) (store.getHead().getRoot())).getDb())
            .getDb().backup(path);
      }
    }
  }
